...
export class BookingRequestService{
    ...
    validateStepThree(booking: BookingRequest, hotesFound){
        ...
        if(hotesFound == 0){
            this._popupToastService.alert('There were no hotels found! Try changing some of your requirements for better chances','middle', 4000);
            return false;
        }
        this._popupToastService.alert('You have not filled all the required fields', 'top');
        return false;
    ...
    validateForSubmit(booking: BookingRequest){
